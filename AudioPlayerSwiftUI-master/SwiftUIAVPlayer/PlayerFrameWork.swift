...
let timeScaleForPlayerFrameWork = CMTimeScale(1000)
let cmTimeForPlayerFramework = CMTime(seconds: 0.5, preferredTimescale: timeScaleForPlayerFrameWork)

/// This is for Slider value changes.
...
final class PlayerFrameWork: NSObject, ObservableObject {
    ...
    fileprivate func addPeriodicTimeObserver() {
        self.periodicTimeObserver = avPlayer.addPeriodicTimeObserver(forInterval: cmTimeForPlayerFramework, queue: .main) { [weak self] (time) in
